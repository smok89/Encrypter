...
func promptOptions() {
	...
	case "e":
		...
		algo, _ := getInput("Which algorithm do you want to use ? (cesar, base32, base64, rot13, vigenere) -> ", reader)
	...
	case "d":
		...
		algo, _ := getInput("Which algorithm was used ? (cesar, base32, base64, rot13, vigenere) -> ", reader)
